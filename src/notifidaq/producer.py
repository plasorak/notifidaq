...
from notifidaq.models.notification_pb2 import SystemType, Notification, Origin, NotificationType
...
class NotifidaqProducer:
    ...
    def notify(self, notification_type:NotificationType, message:msg):
